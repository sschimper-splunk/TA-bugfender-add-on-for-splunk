...
import input_module_bugfender_app_list as input_module
...
'''
    ...
    Add your modular input logic to file input_module_bugfender_app_list.py
'''
class ModInputbugfender_app_list(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.title = ("Bugfender - App List")
