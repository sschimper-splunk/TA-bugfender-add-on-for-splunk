...
import input_module_bugfender_app_logs as input_module
...
'''
    ...
    Add your modular input logic to file input_module_bugfender_app_logs.py
'''
class ModInputbugfender_app_logs(modinput_wrapper.base_modinput.BaseModInput):
